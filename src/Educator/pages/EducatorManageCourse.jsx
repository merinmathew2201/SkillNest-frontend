    ...
    <>
        ...
        {activeTab === "curriculum" && (
            <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="border rounded p-4 mb-4">
                    ...
                    <button onClick={() => setShowLectureModal(true)} className="flex items-center gap-2 text-sm text-cyan-600 cursor-pointer">
                    <FaPlus /> Add Lecture
                    </button>
                </div>

                <button onClick={() => setShowSectionModal(true)} className="flex items-center gap-2 text-sm text-cyan-600 cursor-pointer">
                    <FaPlus /> Add Section
                </button>
            </div>
        )}
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            ...
            <input
                ...
                className="w-full border border-cyan-400 rounded px-3 py-2 mb-4"
            />
