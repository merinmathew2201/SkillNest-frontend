    ...
    <>
      <div className={location.pathname == '/'?"grid grid-cols-3 p-3  bg-sky-50":"grid grid-cols-2 p-3  bg-sky-50"} >
        ...
        {/* search */}
        {
          ...
          <div className='md:flex text-sm  items-center hidden'>
            <input type="text" className="bg-white p-3 rounded-3xl w-full text-black placeholder-grey-500 focus:outline-none focus:ring-1 focus:ring-cyan-500" placeholder='What skill do you want to learn today?' /><div className=' bg-cyan-500 h-8 w-8 rounded-4xl' style={{ marginLeft: '-40px' }} ><FaSearch className='text-white rounded-4xl cursor-pointer' style={{ marginTop: '10px', marginLeft: '8px' }} /></div>
          </div>
        }
      ...
      <nav className='w-full px-3 pb-3 bg-sky-50  md:hidden'>
        ...
        <div className="flex justify-between items-center text-2xl md:hidden">
          ...
          {
            location.pathname == '/' &&
            <div className='flex items-center text-sm mx-5 '><input type="text" className="bg-white p-2 rounded-3xl w-50 text-black placeholder-grey-500" placeholder='search a course..' /><div className=' bg-cyan-500 h-5 w-5 rounded-4xl' style={{ marginLeft: '-30px' }} ><FaSearch className='text-white rounded-4xl cursor-pointer' style={{ marginTop: '5px', marginLeft: '4px' }} /></div></div>
          }
